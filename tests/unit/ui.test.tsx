...
describe('ui primitives', () => {
  ...
  it('renders and updates the interactive primitives', async () => {
    ...
    expect(view.container.querySelector('[data-state]')?.getAttribute('data-state')).toBe('checked:general');

    await click(view.container.querySelector('[role="switch"]'));
    expect(view.container.querySelector('[data-state]')?.getAttribute('data-state')).toBe('unchecked:general');
    ...
    expect(view.container.querySelector('[data-state]')?.getAttribute('data-state')).toBe('unchecked:advanced');
